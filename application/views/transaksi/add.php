<?php echo form_open('Transaksi/add',array("class"=>"form-horizontal")); ?>
	...
	<div class="form-group">
		...
		<div class="col-md-8">
			<input type="text" name="id_transaksi" value="<?php echo $this->input->post('id_transaksi'); ?>" class="form-control" id="id_transaksi" />
		</div>
	</div>
	...
	<div class="form-group">
		...
		<div class="col-md-8">
			<input type="date" name="tgl_transaksi" value="<?php echo $this->input->post('tgl_transaksi'); ?>" class="form-control" id="tgl_transaksi" />
		</div>
	</div>
